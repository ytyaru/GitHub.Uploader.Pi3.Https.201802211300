...
`git push`をHTTPSかSSLのどちらにするかを`./res/config.ini`ファイルで設定できるようにした。

# 前回

ラズパイ3で動作するよう改変した。HTTPS版。

* [GitHub.Uploader.Pi3.Https.201802210700](https://github.com/ytyaru/GitHub.Uploader.Pi3.Https.201802210700)
